...
module Analytics
  class DimPerson < ApplicationRecord
    ...
    has_many :fact_coach_executor_actions, class_name: "Analytics::FactCoachAction", foreign_key: "analyitics_dim_person_executor_id", inverse_of: :dim_person_executor, dependent: :delete_all
    has_many :fact_coach_target_actions, class_name: "Analytics::FactCoachAction", foreign_key: "analyitics_dim_person_target_id", inverse_of: :dim_person_target, dependent: :delete_all
  end
end
