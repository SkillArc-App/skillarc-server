module SubscriberInitializer
  def self.run
    ...
    reactors = [
      ...
      DbStreamListener.build(consumer: People::OnboardingComponent.new, listener_name: "onboardign_component"),
      DbStreamListener.build(consumer: People::PersonDedupingComponent.new, listener_name: "person_deduping_component"),
