...
RSpec.describe DbStreamListener do
  ...
  let!(:event) { create(:event, schema: Users::Events::UserCreated::V1, occurred_at: event_occurred_at) }
  let!(:event2) { create(:event, schema: Users::Events::UserCreated::V1, occurred_at: event_occurred_at + 2.days) }
  ...
  describe "#play" do
    ...
    context "when there is a bookmark" do
      ...
      context "with a second event at the bookmark" do
        ...
        # ordering of uuids
        let!(:same_time_event) { create(:event, schema: Users::Events::UserCreated::V1, id: "ffffffff-ffff-ffff-ffff-ffffffffffff", occurred_at: event_occurred_at) }
