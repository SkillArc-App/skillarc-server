module Screeners
  class ScreenerReactor < MessageReactor
    ...
    on_message Commands::CreateAnswers::V1 do |message|
      ...
      message_service.create_once_for_stream!(
        ...
        schema: Events::AnswersCreated::V1,
        data: {
    ...
    on_message Commands::UpdateAnswers::V1 do |message|
      return unless Projectors::Streams::HasOccurred.project(stream: message.stream, schema: Events::AnswersCreated::V1)
